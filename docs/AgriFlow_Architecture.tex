...
\subsection{Update v1.1: interval terkalibrasi}
Sejak v1.1, baseline yang dilayani ke pengguna membawa \emph{split-conformal rolling-origin
...
akurasi titik demi cakupan). Ini menutup keterbatasan kalibrasi yang sebelumnya dicatat di bagian
ini. Kandidat model berikutnya juga bergeser: alih-alih upgrade ke TimesFM 2.0, kandidat paling
relevan sekarang adalah \textbf{Chronos-2}~\cite{chronosx2025}, karena arsitekturnya
\emph{covariate-aware} secara native (menerima kalender Ramadan dan indeks ENSO tanpa retrofit
terpisah), sejalan dengan kebutuhan kovariat eksogen yang sudah diidentifikasi di atas.
