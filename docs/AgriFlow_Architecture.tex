...
empat baseline (pure-greedy, uniform, proportional-to-deficit, smoothed) pada data Jawa Timur yang
sama, di dua rezim pasokan, dengan metrik: cakupan (volume-weighted), Gini (Lorenz), Atkinson, dan
\emph{leximin} (fulfillment kab terburuk).

\begin{center}
\begin{tabular}{lccccc}
\toprule
\textbf{Rezim / Strategi} & Coverage & Gini & Atkinson($\varepsilon{=}1$) & Sampang & Bangkalan \\
\midrule
...
terlemah saat pasokan langka,"} bukan \emph{"menurunkan ketimpangan secara umum."} Validasi
dijalankan ulang pada \textbf{data produksi/konsumsi BPS asli per-kabupaten (2022)}.
...
tahun acuan konsisten 2022. Seluruh pipeline reproducible dan diuji otomatis (364 tes).
