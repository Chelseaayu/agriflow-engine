...
BPS \& PIHPS Jawa Timur asli per-kabupaten}, dengan \textbf{403 tes otomatis lulus}, dashboard
...
\begin{itemize}
  \item \textbf{Data asli.} Engine berjalan pada data BPS/PIHPS Jawa Timur per-kabupaten ---
        ...
        merah \& putih.
  \item \textbf{Teruji.} 403 tes otomatis lulus (404 terkumpul, 1 di-skip), lintas OS (CI GitHub Actions). Pipeline
        reproducible.
